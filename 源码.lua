...
C4E:Paragraph({Title="队伍检测",Desc="开启后不显示队友的 ESP",Icon="info"})
C4E:Toggle({Title="队伍检测",Value=false,FeatureName="队伍检测",Icon="users",Callback=function(s)ESPC.TeamCheck=s end})
C4E:TextInput({Title="",Placeholder="队伍属性名，如 Team",Value="Team",Callback=function(t)ESPC.TeamAttributeName=t end})
